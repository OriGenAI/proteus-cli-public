...
@runs_authentified
def init_stress_test(bucket, folder, workers=config.WORKERS_COUNT, iterations=config.STRESS_ITERATIONS):
    ...
    click.echo(init_keyword_check(bucket, folder, workers=workers, iterations=iterations))
