...
from proteus import Reporting, api, logger
...
@when(parsers.parse("sending a report with message: {msg}"))
...
@then(parsers.parse("I get a message with: {msg}"))
def message_is_on_output(caplog, msg):
